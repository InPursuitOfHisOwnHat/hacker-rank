...
// For some reason, this code gives me seg faults after the rotLeft function has returned even though it worked and past all test cases on Hackerrank. 
// I haven't looked into this at all, but maybe I will one day! - CAKERS
